...
- If you want to add new components, first create your component directory under the packages directory. The directory starts with `awe`, you can refer to the existing component writing.

- Then create your component document directory in the markdown directory of the doc directory. The directory starts with `awe`, which contains two en-US and zh-CN directories.
