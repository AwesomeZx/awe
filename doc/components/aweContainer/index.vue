<template>
  <div
    class="awedoc-container awedoc-row"
    :class="{ 'awedoc-container--with-simulator': hasSimulator }"
  >
    <div :class="['awe-doc-content', `awe-doc-content--${currentPage}`]">
      <slot />
    </div>
    <div
...
.awedoc-container {
  ...
  .awe-doc-content--,.awe-doc-content--nAbout{
    h1 {
      img{
        margin: 5px;
      }
