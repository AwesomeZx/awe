...
<template>
  <div>
    <awe-button @click="setKeys">通过key选中河南和河北</awe-button>
    <awe-button @click="getKeys">获取所有选中项的keys</awe-button>
    <awe-button @click="getNodes">获取所有选中项的nodes</awe-button>
    <awe-button @click="resetChecked">清空所有选中状态</awe-button>
    <awe-button @click="getNodes">通过key获取河北省节点</awe-button>
    <hr />
    <awe-tree
      ref="tree"
      node-key="id"
...
<template>
  <div>
    <awe-input v-model="input" size="sm" type="text" />
    <awe-tree
      node-key="id"
      :data="treeList"
      :search="input"
...
<template>
  <div>
    <div style="overflow: hidden">
      <awe-button @click="handleAppendRoot()" style="float: right">
        添加根节点
      </awe-button>
    </div>
    <awe-tree
      ...
      <template slot-scope="node">
        <div style="margin: 5px">
          ...
          <awe-button
            ...
            style="float: right;margiawe-right: 10px"
          >添加</awe-button>
        </div>
      </template>
    </awe-tree>
...
| expand-oawe-click-node  | 点击节点时是否展开或折叠 | Boolean | true
| check-oawe-click-node   | 点击节点时是否选中节点 | Boolean | false
