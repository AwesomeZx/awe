...
function createComponentDir () {
  ...
  const targetDirPathName = 'awe' + componentName;
...
function createDocDir () {
  ...
  const docTargetDirPathName = 'awe' + componentName;
...
function createVueFile (subRoot) {
  ...
  const className = 'awe-' + componentName.toLowerCase();
  let vueContent = vueTemplate.replace(/awe-ComponentName/g, className);
...
function createJsFile (subRoot) {
  ...
  const jsContent = jsTemplate.replace(/aweComponentName/g, 'n' + componentName);
